export default function ChangePassword({ handleChangePassword, changePasswordRef, verifyChangePasswordRef, changePasswordError, setShowChangePassword, handleBackButton }) {
            ...
            <div className="max-w-md w-full space-y-8">
                ...
                <form className="mt-8 space-y-6" onSubmit={handleChangePassword}>
                    ...
                    <div className="flex justify-between">
                        <button type="button" onClick={handleBackButton} className="group relative flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            Back
                        </button>
